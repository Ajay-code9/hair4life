    ...
    <div className="bg-dark-950 min-h-screen pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          <h1 className="text-5xl md:text-7xl font-black text-white mb-8">The Hair Journal</h1>
          <p className="text-xl text-white max-w-2xl mx-auto font-serif italic font-medium">
            Practical guidance on hair health, aftercare, and what to expect from treatment—written by our clinical team.
          </p>
        </div>
        ...
        <div className="mt-32 bg-dark-900/30 border border-white/5 rounded-[3rem] p-8 md:p-16 relative overflow-hidden group">
